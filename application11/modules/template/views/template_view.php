        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    ...
                    <a href="<?=base_url('home')?>" style="margin-left: 20px;">
                        <h3 class="logodost logo-default">PAETE</h3><h3 class="logohrmis logo-default">HRMIS</h3> </a>
...
<!--                 <div class="hor-menu  hor-menu-light hidden-sm hidden-xs">
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2025 &copy; MUNICIPAL GOVERNMENT OF PAETE | MISO Version 1.0
            </div>
