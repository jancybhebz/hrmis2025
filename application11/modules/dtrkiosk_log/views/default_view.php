    ...
    <head>
        ...
        <body onload="startTime()" class=" login">
                    ...
                    <div class="content pull-left">
                        ...
                        <?=form_open('dtr', array('method' => 'post'))?>
                            ...
                            <div class="form-actions" style="border: none;text-align: right;">
                                <button type="link" class="btn green uppercase">LOG VIA QR</button> <button type="submit" class="btn green uppercase">Submit</button>
                            </div> 
                        <?=form_close()?>
                    </div>
                </div>
            ...
            <div class="footer">
                ...
                <div class="copyright"> 2025 © MUNICIPAL GOVERNMENT OF PAETE | MISO Version 1.0 </div>
            </div>
