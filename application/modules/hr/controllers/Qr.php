...
class Qr extends MY_Controller {
	...
	public function print()
	{
		...
		$height=30;$i=0;$ctr=0;
		// $arrEmp=array('0516-CO0-2025','2528-CO0-2025','2503-CO0-2025','3528-CO0-2025','0703-CO0-2017','0019-CO0-2025','0001-GAA-2025','0301-CO0-2025','1292-CO0-2007','0015-CO0-2025','0528-CO0-2025','0003-GAA-2025','1290-CO0-2004','0011-CO0-2025','2025-DOST-TRC-00103','1633-TRCDOST-2016','1630-TRCDOST-2016','2025-DOST-TRC-00101','0018-CO0-2025','1301-CO0-2008','1302-CO0-2008','1218-CO0-2000','0313-CO0-2012','2516-CO0-2016','0004-CO0-2012','0003-CO0-2016','0003-CO0-2009','0007-CO0-2015','0016-CO0-2016','0007-CO0-2017','0015-CO0-2016','0030-CO0-2016','0019-GAA-2017','0003-DOSTTRC-2017');
		
		// additional
		$arrEmp=array('1302-CO0-2009','0618-CO0-2025','0009-CO0-2025');
		foreach($rs as $row):
