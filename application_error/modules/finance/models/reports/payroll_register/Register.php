 ...
 * 
 * Copyright (C) 2025 by the MUNICIPAL GOVERNMENT OF PAETE | MISO Version 1.0y Central Office
*/
class Register extends CI_Model {
	...
	function generate($arrData=null)
	{
		...
		// for ($i = 1; $i < 50; $i++) {
		// 	$this->fpdf->cell(0,5,$i.'. MUNICIPAL GOVERNMENT OF PAETE | MISO Version 1.0Y',0,1,'L');	
		// }
		...
		// for ($c = 1; $c < 50; $c++) {
		// 	$this->fpdf->cell(0,5,$c.'. MUNICIPAL GOVERNMENT OF PAETE | MISO Version 1.0Y',0,1,'L');	
		// }
	...
	// 	$this->fpdf->cell(0,5,'MUNICIPAL GOVERNMENT OF PAETE | MISO Version 1.0Y',0,1,'L');
