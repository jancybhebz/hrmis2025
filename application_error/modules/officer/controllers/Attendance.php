...
class Attendance extends MY_Controller {
	...
	public function employees_onottott()
	{
		...
		foreach($employees as $emp):
			# get ob
			$onob = 0;
			$empdtr = $this->Attendance_summary_model->getobs($emp['empNumber'],date('Y-m-d', strtotime('2025-04-23')));
			...
			# get to
			$onto = 0;
			$empdtr = $this->Attendance_summary_model->gettos($emp['empNumber'],date('Y-m-d', strtotime('2025-04-23')));
